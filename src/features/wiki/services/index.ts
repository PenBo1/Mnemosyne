...
import type { WikiEntry, WikiGraphView, WikiEntityLink, CreateWikiEntryRequest, UpdateWikiEntryRequest, WikiCategory, SearchResult } from "@/features/wiki/types";
...
export async function searchWikiSemantic(
  ...
  return ipc<SearchResult[]>("embedding_search", {
    query,
    workspaceId,
    docType: "wiki",
    limit,
