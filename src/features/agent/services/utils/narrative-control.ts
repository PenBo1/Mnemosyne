// Narrative Control —— 纯函数。
//
// 叙事控制块渲染 + AI 味清洗：
//   - sanitizeNarrativeControlText: 把 hook_id / 章节引用 / 套话词替换成中性表达
//   - renderMemoAsNarrativeBlock: 把 ChapterMemo 渲染为 writer/reviser 的叙事控制块
//   - buildNarrativeIntentBrief: 从 markdown 章节意图中提取 6 段并清洗
//   - renderNarrativeSelectedContext: 渲染证据条目（reason/excerpt）
//   - sanitizeNarrativeEvidenceBlock: 清洗证据块，剥除 story/runtime 路径前缀
//
