...
//
// 章节字数度量工具：
// - countChapterLength：按计数模式统计字数（剥除 markdown 元数据后计数）
// - buildLengthSpec：根据目标字数 + 语言构建软硬区间
// - chooseNormalizeMode：根据当前字数决定归一化模式
// - isOutsideSoftRange / isOutsideHardRange：判断是否越界
//
