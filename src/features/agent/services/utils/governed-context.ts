// Governed Context —— 纯函数。
//
// 治理层证据块渲染：从 ContextPackage.selectedContext 中按来源前缀分组，
// 渲染成 7 类证据块（hookDebt / hooks / summaries / volumeSummaries /
// titleHistory / moodTrail / canon），供 writer prompt 拼接。
//
