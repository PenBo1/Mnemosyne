...
//
// 4. strict 模式适配：所有 import 均在文件内被使用（ContextPackage 用于函数签名，
//    parsePendingHooksMarkdown / renderHookSnapshot / isHookWithinChapterWindow 均在
//    buildGovernedHookWorkingSet 内调用），无需调整。无死代码。
//
