// 英文版 prompt 片段工厂。
//
// 业务逻辑零改动（buildEnglishCoreRules / buildEnglishAntiAIRules /
// buildEnglishCharacterMethod / buildEnglishPreWriteChecklist / buildEnglishGenreIntro
// 全部保留）。
//
// 注意：硬编码英文 prompt 字符串是 LLM prompt 模板（非 UI 字符串），
