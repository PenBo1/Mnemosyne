// Settler Prompts（纯函数）。
//
// Settler agent 的 system / user prompt 构造器：
// - buildSettlerSystemPrompt: 基础人设 + 输出格式 + 关键规则
// - buildSettlerUserPrompt: 章节正文 + 当前 truth 文件 + 卷纲/校验反馈
//
// 仅类型 import（BookConfig / GenreProfile / BookRules）。
