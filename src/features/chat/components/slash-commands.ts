...
export const SLASH_COMMANDS: readonly SlashCommand[] = [
  ...
  // ── Stage G 新增：对齐 codex slash commands，适配 Mnemosyne ──
  {
    stem: "/compact",
    hasArgs: false,
    icon: Sparkles,
    labelKey: "slashCompact",
    descKey: "slashCompactDesc",
    category: "action",
  },
  {
    stem: "/skills",
    hasArgs: false,
    icon: Sparkles,
    labelKey: "slashSkills",
    descKey: "slashSkillsDesc",
    category: "navigation",
  },
  {
    stem: "/hooks",
