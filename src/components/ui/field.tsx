...
function FieldLabel({
  ...
  return (
    <Label
      ...
      className={cn(
        "group/field-label peer/field-label flex w-fit gap-2 leading-snug group-data-[disabled=true]/field:opacity-50 has-data-checked:bg-[var(--bg-brand)]/5 has-[>[data-slot=field]]:rounded-[var(--radius-4)] has-[>[data-slot=field]]:border *:data-[slot=field]:p-2",
