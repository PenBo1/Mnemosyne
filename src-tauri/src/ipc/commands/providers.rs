...
) -> Result<IpcResponse<Vec<crate::infrastructure::llm_client::ProviderInfo>>, AppError> {
...
pub async fn provider_models(
    state: State<'_, AppState>,
) -> Result<IpcResponse<Vec<crate::infrastructure::llm_client::ModelInfo>>, AppError> {
...
pub async fn provider_refresh(
    ...
    let new_registry = crate::infrastructure::llm_client::ProviderRegistry::new(&state.data_dir);
