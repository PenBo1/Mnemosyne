...
use crate::infrastructure::db::models::{CreateKanbanTaskRequest, UpdateKanbanTaskRequest, CreateKanbanColumnRequest, UpdateKanbanColumnRequest};
...
) -> Result<IpcResponse<crate::infrastructure::db::models::KanbanTask>, AppError> {
...
) -> Result<IpcResponse<Vec<crate::infrastructure::db::models::KanbanTask>>, AppError> {
    validate_id_component(&novel_id, "novel_id")?;
...
pub async fn kanban_get_columns(
    state: State<'_, AppState>,
    novel_id: String,
) -> Result<IpcResponse<Vec<crate::infrastructure::db::models::KanbanColumn>>, AppError> {
    validate_id_component(&novel_id, "novel_id")?;
...
) -> Result<IpcResponse<crate::infrastructure::db::models::KanbanColumn>, AppError> {
    validate_id_component(&novel_id, "novel_id")?;
