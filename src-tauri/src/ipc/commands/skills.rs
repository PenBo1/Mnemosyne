...
use crate::AppState;
use crate::features::skill_manager::SkillMeta;
use tauri::State;
...
) -> Result<IpcResponse<Vec<crate::features::skill_manager::SkillMeta>>, AppError> {
...
pub async fn skill_get(
    state: State<'_, AppState>,
    name: String,
) -> Result<IpcResponse<crate::features::skill_manager::Skill>, AppError> {
