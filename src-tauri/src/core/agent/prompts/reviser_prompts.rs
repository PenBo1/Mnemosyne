...
pub fn build_user_message(
    chapter_number: u32,
    chapter_content: &str,
    audit: &crate::features::story::AuditResult,
    language: &str,
) -> String {
    let issues_summary: Vec<String> = audit.issues.iter().map(|i| {
        let severity_str = match i.severity {
            crate::features::story::AuditSeverity::Critical => "CRITICAL",
            crate::features::story::AuditSeverity::Warning => "WARNING",
            crate::features::story::AuditSeverity::Info => "INFO",
        };
