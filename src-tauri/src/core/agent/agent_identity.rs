...
impl AgentIdentity {
    ...
    pub async fn build_system_prompt_with_memory(
        &self,
        memory: &tokio::sync::RwLock<crate::core::agent::base::MemorySystem>,
        context_query: &str,
        skill_manager: Option<&crate::features::skill_manager::discovery::SkillManager>,
        user_profile: Option<&tokio::sync::Mutex<crate::features::user_profile::UserProfileStore>>,
    ) -> String {
