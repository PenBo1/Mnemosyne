...
use crate::infra::llm::types::{Message, ToolSpec};
...
pub fn compact_messages_simple(messages: &[crate::infra::db::Message]) -> String {
    let keep_recent = 10;
...
mod tests {
    ...
    fn test_build_system_prompt_includes_default() {
        let feedback = crate::infra::feedback::FeedbackStore::new();
        let skills = crate::infra::skill::SkillManager::new();
