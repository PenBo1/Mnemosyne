...
pub fn build_creative_user_prompt(
    ...
    chapter_number: u32,
    plan: &crate::domain::agents::planner::PlanOutput,
    composed: &crate::domain::agents::composer::ComposeOutput,
    language: &str,
...
fn render_context_sources(sources: &[crate::domain::agents::governance::ContextSource], language: &str) -> String {
    if sources.is_empty() {
