...
use crate::domain::agents::governance::{ChapterIntent, ChapterMemo};
...
pub fn render_narrative_selected_context(entries: &[crate::domain::agents::governance::ContextSource], language: &str) -> String {
